...
batch_names <- c("cellBench", "pancreas", "csf_media_storage", "pbmc_media_storage", "pbmc2_media_storage", "csf_patient", "pbmc2_patient")

batch_names_short <- c("protocol", "protocol2", "storage", "media", "media2", "patient", "patient2")
...
scale_vars <- c("batch_genes_1per", "batch_genes_10per", "celltype_gene_1per",      "relative_batch_celltype")
...
batch_type_mat <- t(as.matrix(c(rep("protocol", 2), "storage", rep("media", 2), rep("patient", 2))))
...
size_variables <- c("cms", "genes", "Variance Part.", "Genes")
