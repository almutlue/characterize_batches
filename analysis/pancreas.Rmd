...
**Pancreas data**, test batch effect from different protocols. For the purposes of this example, it was chosen human pancreatic islet cell datasets produced across four technologies, CelSeq (GSE81076) CelSeq2 (GSE85241), Fluidigm C1 (GSE86469), and SMART-Seq2 (E-MTAB-5061). 
...
signs <- sample(c(-1, 1), nrow(lfc_dist), TRUE, prob = c(0.7, 0.3))
...
signs <- sample(c(-1, 1), length(batch_gene), TRUE, prob = c(0.1, 0.9))
