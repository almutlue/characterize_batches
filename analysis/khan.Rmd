...
# Media batch effects
**Khang data**, test batch effect from different patient. Droplet-based scRNA-seq PBMC data from 8 Lupus patients before and after 6h-treatment with INF-beta.
Represented as a SingleCellExperiment; derived from GEO accession number GSE96583.
